...
for i = 1, 3 do
	...
	f:CreatePanel("Default", 26, 26, "CENTER", _G["TempEnchant"..i], "CENTER", 0, 0)	
	...
	_G["TempEnchant"..i]:SetHeight(E.Scale(26))
	_G["TempEnchant"..i]:SetWidth(E.Scale(26))	
...
local function StyleBuffs(buttonName, index, debuff)
	...
	if icon and not _G[buttonName..index.."Panel"] then
		...
		if ( debuff == true) then
			...
			buff:SetHeight(E.Scale(46))
			buff:SetWidth(E.Scale(46))		
		end
