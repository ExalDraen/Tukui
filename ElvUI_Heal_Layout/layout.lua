...
if powerbar_offset ~= 0 then
	focus:SetPoint("TOPLEFT", ElvHeal_target, "BOTTOMLEFT", E.Scale(9),E.Scale(-42))
else
	focus:SetPoint("TOPLEFT", ElvHeal_target, "BOTTOMLEFT", 0,E.Scale(-42))
end
...
if ElvHeal_player.ThreatBar then
	if powerbar_offset ~= 0 then
		ElvHeal_player.ThreatBar:SetPoint("TOPLEFT", ElvHeal_target.Health, "BOTTOMLEFT", 0, -powerbar_offset + -E.Scale(5))
	else
		ElvHeal_player.ThreatBar:SetPoint("TOPRIGHT", ElvHeal_target.Health, "BOTTOMRIGHT", 0, -(ElvHeal_target.Health:GetHeight() * 0.35) + -E.Scale(8))
	end
end